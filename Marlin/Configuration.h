...
#define STRING_CONFIG_H_AUTHOR "(nbadal, Ender-3 Pro SKR 1.4T)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 33.58, 33.58 }
    #define DEFAULT_Ki_LIST {  3.49, 3.49  }
    #define DEFAULT_Kd_LIST { 80.89, 80.89 }
  #else
    #define DEFAULT_Kp 33.58
    #define DEFAULT_Ki 3.49
    #define DEFAULT_Kd 80.89
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 84.92
  #define DEFAULT_bedKi 13.36
  #define DEFAULT_bedKd 359.86
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.94 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -8.7, -1.25 }
